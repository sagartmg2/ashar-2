...
/* arrow function */
const findCountryCode1 = (inputCountryName) => {
    // let countryCode = null
    /* code here. for-loop  & if else  */

    for (let index = 0; index < countries.length; index++) {
        let country = countries[index];
        inputCountryName = inputCountryName.trim()
        if (country.name == inputCountryName || country.path == inputCountryName) {
            return country.code  // returns terminate the function
            countryCode = country.code
        }
    }

    // return undefined // default functions return undefined.
    // return countryCode
}


const findCountryCode2 = (inputCountryName) => {

    for (let index = 0; index < countries.length; index++) {
        let country = countries[index];
        inputCountryName = inputCountryName.trim()
        inputCountryName = inputCountryName.toLowerCase()
...
const findCountryCode = (inputCountryName) => {
    let countryCode = null
    // for (let index = 0; index < countries.length; index++) {
    //     let country = countries[index];
    //     inputCountryName = inputCountryName.trim()
...
console.log("code ", findCountryCode("Zimbabwe"))  // np




// let numbers = [1, 1, 2, 2, 34, 5, 6, 7, 8]
let numbers = [6, 7, 8]
...
const doSomething = (element, index) => {
    console.log("do somehting", element, index);
}
